...
const venues = [
  { id: "school", name: "School Gym", image: "assets/images/venue_school_gym.jpg" },
  { id: "outdoor", name: "Outdoor Medium Stage", image: "assets/images/venue_outdoor_stage.jpg" },
  { id: "snow", name: "Snow Forest Stage", image: "assets/images/venue_snow_forest.jpg" },
  { id: "arena", name: "Large Arena", image: "assets/images/venue_large_arena.jpg" },
  { id: "front-row", name: "Front Row", image: "assets/images/venue_front_row.jpg" }
];
...
const outfits = [
  { id: "the-right-guy", name: "The Right Guy Outfit", song: "the-right-guy", image: "assets/yafania/chibi_the_right_guy.jpg" },
  { id: "dont-you-want-to-be-with-me", name: "Don't You Want To Be With Me Outfit", song: "dont-you-want", image: "assets/yafania/chibi_dont_you_want_to_be_with_me.jpg" },
  { id: "the-last-goodbye", name: "The Last Goodbye Outfit", song: "last-goodbye", image: "assets/yafania/chibi_the_last_goodbye.jpeg" },
  { id: "when-im-with-you", name: "When I'm With You Outfit", song: "when-im-with-you", image: "assets/yafania/chibi_when_im_with_you.jpg" }
];
...
const songs = [
  {
    ...
    original: "assets/audio/the_right_guy_original.mp3",
    instrumental: "assets/audio/the_right_guy_instrumental.mp3"
  },
  {
    id: "dont-you-want",
    ...
    original: "assets/audio/dont_you_want_to_be_with_me_original.mp3",
    instrumental: "assets/audio/dont_you_want_to_be_with_me_instrumental.mp3"
  },
  {
    id: "last-goodbye",
    ...
    original: "assets/audio/the_last_goodbye_original.mp3",
    instrumental: "assets/audio/the_last_goodbye_instrumental.mp3"
  },
  {
    id: "when-im-with-you",
    ...
    original: "assets/audio/when_im_with_you_original.mp3",
    instrumental: "assets/audio/when_im_with_you_instrumental.mp3"
  }
];
...
function songPanel() {
  ...
  ["original", "instrumental"].forEach((version) => {
    const button = chip(version[0].toUpperCase() + version.slice(1), state.version === version);
    button.addEventListener("click", () => {
...
function yafaniaImage() {
  ...
  img.src = outfit ? outfit.image : "assets/yafania/chibi_default.png";
